...
public class Potions {
    ...
    public static final PotionType Composure_Potion = new PotionType("composure", new PotionEffect(Composure, 900)).setRegistryName("composure");
    public static final PotionType Long_Composure_Potion = new PotionType("composure", new PotionEffect(Composure, 1400)).setRegistryName("long_composure");
    public static final PotionType Strong_Composure_Potion = new PotionType("composure", new PotionEffect(Composure, 600, 1)).setRegistryName("strong_composure");
